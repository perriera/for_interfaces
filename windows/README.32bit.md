...
> remove '-m32' from lines 53 & 54 in CMakeLists.txt 
> and change 6.1.0 to 6.0.0 on line 129 in libinjections.so.0.1.0
...
$ cd build<br/>
$ file libinjections.so.0.1.0<br/><br/>
libinjections.so.0.1.0: ELF 32-bit LSB shared object, Intel 80386, version 1 (SYSV), dynamically linked, BuildID[sha1]=854b1299e523cbac6487e574e009fdafe6193d88, with debug_info, not stripped
