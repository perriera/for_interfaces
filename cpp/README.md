...
**Note**: We build [Unix shell](https://en.wikipedia.org/wiki/Unix_shell) applications first then attach GUI platforms to the shared libraries of these applications
